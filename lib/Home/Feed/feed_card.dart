...
class FeedCard extends StatefulWidget {
  ...
  FeedCard({required this.number});

  @override
  State<FeedCard> createState() => _PostCardState();
}

class _PostCardState extends State<FeedCard> {
        ...
        children: [
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    ...
                    fit: BoxFit.cover,
                    width: MediaQuery.of(context).size.width - 100, // 조정된 이미지의 폭
                    height: 230,
                  ),
                ),
              ),
          ...
          Container(
            ...
            child: Container(
              ...
              child: Text(
                '''dashjdfkghjkfadsjghkfasdgjkh
                asfdjhkggjashkfdjhgkadsfgjhafsd
                asfdghjafsdjghkjfghads
                asdfhjkfhjklsadhjkldfashjkl
                asfdjhkfhkjadskhjlfsdahj
                sadfhjkkhjasfdhkjlfasdhjklfasdhlkj''',
                maxLines: 5,
