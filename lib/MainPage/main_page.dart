...
class ImageSearchPageWidgetState extends State<ImageSearchPageWidget> {
  ...
  void searchImages() async {
    ...
    String url = 'https://dapi.kakao.com/v2/search/image?query=$query&page=$page&sort=relevance';
    Dio dio = Dio();
  ...
  void _toggleImageFavorite(int index) {
    setState(() {
      if (ImageFavoriteList[index]) {
        ...
        // 하트 누르기
        ImageFavoriteList[index] = true; // 하트 버튼 인덱스로 표시
        //ImageFavoriteData에 추가하기
